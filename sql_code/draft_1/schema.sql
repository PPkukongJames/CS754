...
create table LEAVE_HISTORY (
    ...
    LEAVE_TYPE varchar(90) NOT NULL,
    EMP_ID int NOT NULL,
    LEAVE_STATUS char(1) NOT NULL,
    FOREIGN KEY (EMP_ID) REFERENCES EMPLOYEE(EMP_ID)
)
COMMENT = 'ประวัติการลา';
...
create table PRODUCT_IN(
    PRODUCT_IN_ID int primary key AUTO_INCREMENT,
...
create table PRODUCT_OUT(
    PRODUCT_OUT_ID int primary key AUTO_INCREMENT,
    PRODUCT_ID int NOT NULL,
    PRODUCT_OUT_DATE date NOT NULL,
    EMP_ID int NOT NULL,
    AMOUNT float NOT NULL,
    FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT(PRODUCT_ID),
    FOREIGN KEY (EMP_ID) REFERENCES EMPLOYEE(EMP_ID)
...
create table ORDER_DETAIL(
    ...
    FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT_OUT(PRODUCT_ID),
